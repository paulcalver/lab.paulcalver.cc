...
let animationDuration = 5000; // 1 second in milliseconds
...
function draw() {
    ...
    let swColour = map(shortwave24, 0, 60, 150, 20);
    swColour = constrain(swColour, 20, 150);
    ...
    background(swColour, 100, 40 + swShift);
...
let gridSize = height * 1;
  ...
  let motionAlpha = map(motionMagnitude, 0, 15, 0, 1, true); // Clamp to 0-1
